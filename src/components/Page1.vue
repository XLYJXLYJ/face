	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;padding-top:16px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-button type="primary" @click="handleAdd">照片注册</el-button>
				</el-form-item>
				<el-form-item>
					<el-button type="primary" @click="cardAdd">拍照注册</el-button>
				</el-form-item>
			</el-form>
		</el-col>
					...
					<div class="registercontain" v-show="registerShow">
							<el-form label-width="90px">
								...
								<el-form-item label="照片">
									...
									<br>
									<el-button class="register" @click.prevent="Loginbtn" type="primary">注册</el-button>
							</el-form> 
					</div>
				</el-dialog> 
		</transition>
		...
		<transition name="el-fade-in-linear">
				<el-dialog :visible.sync="dialogUpdate"  width="480px" :modal="true" :modal-append-to-body="false" :lock-scroll="false" :show-close="false">
					<div class="registercontain" v-show="updateShow">
							<el-form label-width="90px">
								<el-form-item label="personId">
									<el-input v-model="formUpdate.personId" placeholder="请输入personId"></el-input>
								</el-form-item>
									<br>
								<el-form-item label="faceId">
									<el-input v-model="formUpdate.faceId" placeholder="请输入faceId"></el-input>
								</el-form-item>
									<br>
								<el-form-item label="照片">
									<el-upload
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="personId" label="Id" width="100" sortable>
			</el-table-column>
		...
		<!--工具条-->
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;padding-top:16px;">
			<!-- <el-button type="danger" @click="Removeall" :disabled="this.sels.length===0">删除所有照片</el-button> -->
