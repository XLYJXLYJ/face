	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;padding-top:16px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-button type="primary" @click="handleEdit">刷卡记录删除</el-button>
				</el-form-item>
			</el-form>
		</el-col>
...
var moment = require('moment');
	...
	           return moment(date).format("YYYY-MM-DD HH:mm:ss");
			...
			Loginbtn(){
				this.axios.post('/deleteICRecords',
				qs.stringify({
					pass:'create1',
			...
			getid(){
				this.axios.get('/findICRecords?pass=create1&personId='+this.nameid+'&length=10&index=0&startTime=0&endTime=0',
				{
					headers: {'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8',
					'Access-Control-Allow-Headers':'*'},
				})
			...
			//根据页数获取数据
			getData(){
				this.axios.get('/findICRecords?pass=create1&personId=-1&length=10&index='+this.cur_page+'&startTime=0&endTime=0',
				{
					headers: {'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8',
					'Access-Control-Allow-Headers':'*'},
				})
